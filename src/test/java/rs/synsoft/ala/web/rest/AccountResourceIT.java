...
import static rs.synsoft.ala.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import rs.synsoft.ala.JhipsterSampleApplication111App;
import rs.synsoft.ala.config.Constants;
import rs.synsoft.ala.domain.Authority;
import rs.synsoft.ala.domain.User;
import rs.synsoft.ala.repository.AuthorityRepository;
import rs.synsoft.ala.repository.UserRepository;
import rs.synsoft.ala.security.AuthoritiesConstants;
import rs.synsoft.ala.service.UserService;
import rs.synsoft.ala.service.dto.PasswordChangeDTO;
import rs.synsoft.ala.service.dto.UserDTO;
import rs.synsoft.ala.web.rest.vm.KeyAndPasswordVM;
import rs.synsoft.ala.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterSampleApplication111App.class)
